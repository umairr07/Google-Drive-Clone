...
import { STARRED_IMG } from "../../constants_urls/urls";

function StarredComp() {
  return (
      ...
      <div className="flex ">
        ...
        <div className="w-[80%] bg-[#fff] m-4 p-3 rounded-xl dark:bg-[#131314]">
          ...
          <div className="flex flex-col justify-center items-center gap-8 my-16">
            <img src={STARRED_IMG} alt="" className="w-[300px]" />
            <div className="text-center">
              <p className="text-xl font-medium">No Starred files</p>
